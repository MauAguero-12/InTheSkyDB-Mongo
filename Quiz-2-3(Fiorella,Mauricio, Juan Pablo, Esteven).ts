...
// Quiz #2 y #2
// Realizado por:
//          FIORELLA ARIAS ARIAS
//          MAURICIO AGUERO MARQUEZ 
//          JUAN PABLO SOTO ROJAS     
//          ESTEVEN FERNANDEZ HERNANDEZ
...
const Zoom = mongoose.model('zoom',  //guarda los datos necesarios para el zoom y las escalas de zoom
 {
    nombreOpcion : String,
